...
/*
Этот класс используется для получения журнала записей на приемы.
Но так как я не смог реализовать программную фильтрацию времени - класс не нужен.
Я его оставлю, т.к. в будущем, если проект будет развиваться - класс может пригодиться...
 */
